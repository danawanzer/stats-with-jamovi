...
-   *t~obt~ \> t~crit~* means we reject the null hypothesis (*p* \< alpha, which is usually set to .05)

-   *t~obt~ \< t~crit~* means we fail to reject the null hypothesis (*p* \> alpha, which is usually set to .05)
...
*Note*: It does not matter if you get a negative value. Use the absolute value of the *t*~obt~ that you get to compare to your *t*~crit~.
