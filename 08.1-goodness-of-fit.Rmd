...
To test this assumption, select "Expected counts" in jamovi. Examine the expected counts (not proportion) in the output. If all expected values are greater than 5 then you meet the assumption. 
