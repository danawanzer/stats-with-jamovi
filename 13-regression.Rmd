...
```{block, type = "info"}
This math section is actually not too mathy! There's also fun images in it. I encourage you all to read it, especially since all of you should have familiarity with line equations like y = mx + b. 
```
...
```{r echo = FALSE, fig.cap = "Checking for multivariate outliers in jamovi"}
knitr::include_graphics("images/13-regression/regression-cooks.png")
```
...
```{r echo = FALSE, fig.cap = "Checking the normality of residuals in jamovi"}
knitr::include_graphics("images/13-regression/regression-normality.png")
```
...
```{r echo = FALSE, fig.cap = "Checking linearity and homoscedasticity residuals in jamovi", fig.show='hold',fig.align='center', out.width = "49%"}
knitr::include_graphics(c("images/13-regression/regression-residuals.png", "images/13-regression/regression-residuals2.png"))
knitr::include_graphics(c("images/13-regression/regression-residuals3.png", "images/13-regression/regression-residuals4.png"))
```
...
```{r echo = FALSE, fig.cap = "Checking independence of residuals in jamovi"}
knitr::include_graphics("images/13-regression/regression-durbinwatson.png")
```
...
```{r echo = FALSE, fig.cap = "Checking multicollinearity in jamovi"}
knitr::include_graphics("images/13-regression/regression-multicollinearity.png")
```
...
```{r echo = FALSE, fig.cap = "Regression results in jamovi"}
knitr::include_graphics("images/13-regression/regression-results.png")
```
...
```{r echo = FALSE, fig.cap = "Hierarchical regression setup in jamovi"}
knitr::include_graphics("images/13-regression/hierarchical-setup.png")
```
...
```{r echo = FALSE, fig.cap = "Hierarchical regression results in jamovi"}
knitr::include_graphics("images/13-regression/hierarchical-results.png")
```
...
```{r echo = FALSE, fig.cap = "Transforming day into a categorical variable in jamovi"}
knitr::include_graphics("images/13-regression/transform.png")
```
...
```{r echo = FALSE, fig.cap = "Regression with a categorical predictor results in jamovi"}
knitr::include_graphics("images/13-regression/regression-categorical.png")
```
...
```{r echo = FALSE, fig.cap = "Regression with a categorical predictor results in jamovi"}
knitr::include_graphics("images/13-regression/regression-categorical-EMM.png")
```
...
1.  **Perform a multiple regression examining how `English`**, **`Reading` and `Writing`, as well as `Gender` relate to the dependent variable `Math`.**
    ...
    -   Do you have any significant outliers? `r mcq(c("yes", answer = "no"))`

    -   Are your residuals normally distributed? `r mcq(c(answer = "yes", "no"))`

    -   Do you satisfy the assumption of linearity and homoscedasticity of your residuals (just check the Fitted residual plot)? `r mcq(c(answer = "yes", "no"))`

    -   Do you meet the assumption of independent residuals? `r mcq(c(answer = "yes", "no"))`

    -   Do you meet the assumption of no multicollinearity? `r mcq(c(answer = "yes", "no"))`

    -   Can you perform a regression with this data? `r mcq(c(answer = "yes", "no"))`

    -   What is your adjusted R-squared, rounded to two decimal places: `r fitb(".31")`

    -   Is the overall model statistically significant? `r mcq(c(answer = "yes", "no"))`

    -   Is `English` statistically significant? `r mcq(c("yes", answer = "no"))`

    -   Is `Reading` statistically significant? `r mcq(c(answer = "yes", "no"))`

    -   Is `Writing` statistically significant? `r mcq(c(answer = "yes", "no"))`

    -   Is `Gender` statistically significant? `r mcq(c(answer = "yes", "no"))`

    -   For `Gender`, do male (Gender = 0) or female (Gender = 1) students have higher math scores? `r mcq(c(answer = "male", "female"))`
