...
-   $H_0$: There are no differences in frequencies of how the levels in one variable relate to the levels in another variable.

-   $H_1$: At least one level in one variable has significantly different frequencies in another variable than we would expect.
...
This is what we would call a 2x3 chi-square test because the first variable species has two levels (robot or human) and the second variable choice has three levels (puppies, flowers, data).
