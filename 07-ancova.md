...
<img src="images/07-ancova/ancova_assumptions.png" alt="Assumption check results in jamovi" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="images/07-ancova/ancova_assumptions2.png" alt="Assumption check results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-2)Assumption check results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/07-ancova/ancova_assumptions3.png" alt="Assumption check results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-3)Assumption check results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/07-ancova/ancova_results.png" alt="ANCOVA results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-4)ANCOVA results in jamovi</p>
</div>

<div class="info">
<p>Technically, we don’t need to look at the post hoc table much in this example. Because there are only two groups, we already know one group will have higher means than the other group if the F-test is significant. In fact, check this out: the square root of our F-statistic is equal to the t-statistic in our post hoc table. Neat!</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/07-ancova/ancova_tukey.png" alt="Post hoc results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-6)Post hoc results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/07-ancova/ancova_interaction.png" alt="Interaction in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-7)Interaction in jamovi</p>
</div>
