...
What is Dr. Chico's alternative hypothesis? `r mcq(c("test 1 scores are different from test 2 scores", "test 1 scores are greater than test 2 scores", answer = "test 1 scores are less than test 2 scores"))`
...
```{r echo = FALSE, fig.cap = "Dependent t-test data in jamovi", out.width = "80%"}
knitr::include_graphics("images/03_dependent_t-test/dependent_data.png")
```

In the data above, what is your **independent variable**? `r mcq(c("id", answer = "grade", "test score", "grade_test1", "grade_test2"))`

In the data above, what is your **dependent variable**? `r mcq(c("id", "grade", answer = "test score", "grade_test1", "grade_test2"))`
...
knitr::include_graphics("images/03_dependent_t-test/dependent_descriptives.png")
```
...
```{r echo = FALSE, fig.cap = "Plots of the data", fig.show='hold',fig.align='center', out.width = "49%"}
knitr::include_graphics(c("images/03_dependent_t-test/dependent_plot1.png", "images/03_dependent_t-test/dependent_plot2.png"))
```
...
```{r echo = FALSE, fig.cap = "Dependent t-test descriptives plot"}
knitr::include_graphics("images/03_dependent_t-test/dependent_results_plot.png")
```
...
```{r echo = FALSE, fig.cap = "Revised plot using the Rj editor"}
knitr::include_graphics("images/03_dependent_t-test/dependent_results_plot2.png")
```
