...
Students often worry about positive or negative t-statistic values and are unsure how to interpret it. Positive or negative t-statistic values simply occur based on which group is listed first. Our t-statistic above is positive because we tested the difference between the first test (*M* = 56.98) versus the second test (*M* = 58.38) and so Test1 - Test2 is a mean difference of -1.40 and a *t*-statistic of -6.48.

However, if our classes were reversed, our mean difference would 1.40 and our t-statistic would be 6.48.
