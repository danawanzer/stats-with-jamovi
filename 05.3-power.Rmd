...
1.  alpha `r mcq(c(answer = "A", "B", "C", "D"))`
2.  power `r mcq(c("A", answer = "B", "C", "D"))`
3.  type I error `r mcq(c(answer = "A", "B", "C", "D"))`
4.  Type II error `r mcq(c("A", "B", "C", answer = "D"))`
5.  Correct inference \#1 `r mcq(c("A", answer = "B", "C", "D"))`
6.  Correct inference \#2 `r mcq(c("A", "B", answer = "C", "D"))`
...
When we assume the null and alternative hypotheses are 50% likely each, and we set our alpha to 1% and our power to 95%, it is `r fitb("95")` times more likely that the alternative hypothesis is true than the null hypothesis is true.
