...
<!--chapter:end:02.0-statistics-foundations.Rmd-->
...
<!--chapter:end:02.1-key-terms.Rmd-->
...
<!--chapter:end:03.0-overview-jamovi.Rmd-->
...
<!--chapter:end:03.1-descriptive-statistics.Rmd-->
...
<!--chapter:end:03.2-cleaning-data.Rmd-->
...
<!--chapter:end:04.0-hypothesis-testing.Rmd-->
...
<!--chapter:end:05.1-effect-sizes.Rmd-->
...
However, a year later, even Fisher acknowledged we shouldn't just arbitrarily use *p* = .05 as our alpha level.[^p-values-1] Rather, we should consider setting it at higher odds (e.g., *p* = .01). He also argued, "A scientific fact should be regarded as experimentally established only if a properly designed experiment *rarely fails* to give this level of significance." (Fisher, 1926, p. 504).
...
<!--chapter:end:05.4-sample-size.Rmd-->
...
<!--chapter:end:06.0-inferential-stats.Rmd-->
...
<!--chapter:end:06.1-choosing-test.Rmd-->
...
<!--chapter:end:06.2-checking-assumptions.Rmd-->
...
<!--chapter:end:06.3-violated-assumptions.Rmd-->
...
<!--chapter:end:07.1-one_sample_t-test.Rmd-->
...
\caption{Testing assumptions in jamovi}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Testing assumptions in jamovi}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{One-way ANOVA results in jamovi}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Kruskal-Wallis results in jamovi}(\#fig:unnamed-chunk-6)
\end{figure}
...
<!--chapter:end:09.1-one-way-anova.Rmd-->
...
\caption{Contrasts - Deviation}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Contrasts - Simple}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{Contrasts - Difference}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Contrasts - Helmert}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Contrasts - Repeated}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Contrasts - Polynomial}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Post hoc test results in jamovi}(\#fig:unnamed-chunk-7)
\end{figure}
...
<!--chapter:end:09.2-finding-group-differences.Rmd-->
...
In the data above, what is your **independent variable**? <select class='solveme' data-answer='["Condition"]'> <option></option> <option>Participant</option> <option>Condition</option> <option>Speech</option> <option>Conceptual</option> <option>Syntax</option> <option>TestScore</option></select>

In the data above, what is your **dependent variable**? <select class='solveme' data-answer='["TestScore"]'> <option></option> <option>Participant</option> <option>Condition</option> <option>Speech</option> <option>Conceptual</option> <option>Syntax</option> <option>TestScore</option></select>
...
\caption{Testing sphericity in jamovi}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Repeated Measures ANOVA setup in jamovi}(\#fig:unnamed-chunk-8)
\end{figure}
...
<!--chapter:end:09.3-repeated-measures-anova.Rmd-->
...
<!--chapter:end:09.4-factorial-anova.Rmd-->
...
\caption{Post hoc results in jamovi}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Interaction in jamovi}(\#fig:unnamed-chunk-6)
\end{figure}

<!--chapter:end:09.5-ancova.Rmd-->
...
<!--chapter:end:10.0-correlation-regression.Rmd-->
...
\caption{Scatter plots and correlation examples}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Testing linearity in jamovi}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{Comparison of correlations from independent samples}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Advanced filters}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Comparison of correlations from dependent samples}(\#fig:unnamed-chunk-5)
\end{figure}
...
<!--chapter:end:10.1-correlation.Rmd-->
...
\caption{Regression lines and residuals}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Checking for multivariate outliers in jamovi}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Checking the normality of residuals in jamovi}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Checking linearity and homoscedasticity residuals in jamovi}(\#fig:unnamed-chunk-7)
\end{figure}
...
\caption{Checking independence of residuals in jamovi}(\#fig:unnamed-chunk-8)
\end{figure}
...
\caption{Checking multicollinearity in jamovi}(\#fig:unnamed-chunk-9)
\end{figure}
...
\caption{Regression results in jamovi}(\#fig:unnamed-chunk-10)
\end{figure}
...
\caption{Hierarchical regression setup in jamovi}(\#fig:unnamed-chunk-11)
\end{figure}
...
\caption{Hierarchical regression results in jamovi}(\#fig:unnamed-chunk-12)
\end{figure}
...
\caption{Transforming day into a categorical variable in jamovi}(\#fig:unnamed-chunk-13)
\end{figure}
...
\caption{Regression with a categorical predictor results in jamovi}(\#fig:unnamed-chunk-14)
\end{figure}
...
1.  **Perform a multiple regression examining how `English`**, **`Reading` and `Writing`, as well as `Gender` relate to the dependent variable `Math`.**
    ...
    -   Do you meet the assumption of independent residuals? <select class='solveme' data-answer='["yes"]'> <option></option> <option>yes</option> <option>no</option></select>
...
<!--chapter:end:10.2-regression.Rmd-->
...
<!--chapter:end:10.3-regression-wrap-up.Rmd-->
