...
1.  **Do the students in our dataset have a higher Writing score than passing (*M* = 70)?**
    ...
    -   Which statistic should you use based on your assumptions? `r mcq(c("Student one sample t-test", answer = "Wilcoxon rank one sample t-test"))`
...
2.  **Do the students in our dataset have the same national average height of college students (*M* = 68 inches)?**
    ...
    -   Which statistic should you use based on your assumptions? `r mcq(c(answer = "Student one sample t-test", "Wilcoxon rank one sample t-test"))`
