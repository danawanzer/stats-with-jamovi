...
```{r echo = FALSE, fig.cap = "One-sample t-test data in jamovi", out.width = "80%"}
knitr::include_graphics("images/07.1-one_sample_t-test/data.png")
```
...
```{r echo = FALSE, fig.cap = "Descriptive statistics", out.width = "80%"}
knitr::include_graphics("images/07.1-one_sample_t-test/descriptives.png")
```

```{r echo = FALSE, fig.cap = "Plot of the data", out.width = "80%"}
knitr::include_graphics("images/07.1-one_sample_t-test/plot.png")
```
...
knitr::include_graphics("images/07.1-one_sample_t-test/normality.png")
```
...
```{r echo = FALSE, fig.cap = "One sample t-test setup in jamovi", out.width = "80%"}
knitr::include_graphics("images/07.1-one_sample_t-test/setup.png")
```
...
```{r echo = FALSE, fig.cap = "One sample t-test results in jamovi"}
knitr::include_graphics("images/07.1-one_sample_t-test/results.png")
```
...
```{r echo = FALSE, fig.cap = "One sample t-test descriptives plot"}
knitr::include_graphics("images/07.1-one_sample_t-test/results-plot.png")
```
...
```{r echo = FALSE, fig.cap = "All one sample t-test results in jamovi"}
knitr::include_graphics("images/07.1-one_sample_t-test/wilcoxon.png")
```
...
1.  **Do the students in our dataset have a higher Writing score than passing (*M* = 70)?**
    ...
    -   Which statistic should you use based on your assumptions? `r mcq(c("Student's one sample t-test", answer = "Wilcoxon rank one sample t-test"))`

    -   Do the students in our dataset have a higher Writing score than passing (*M* = 70)? `r mcq(c(answer = "yes", "no"))`
...
2.  **Do the students in our dataset have the same national average height of college students (*M* = 68 inches)?**
    ...
    -   Which statistic should you use based on your assumptions? `r mcq(c(answer = "Student's one sample t-test", "Wilcoxon rank one sample t-test"))`

    -   Do the students in our dataset have the same national average height of college students)? `r mcq(c("yes", answer = "no"))`
