...
```{r echo = FALSE, fig.cap = "McNemar's test setup in jamovi", out.width = "80%"}
knitr::include_graphics("images/12-mcnemar/mcnemar_setup.png")
```

### Interpret results

```{r echo = FALSE, fig.cap = "McNemar's test results in jamovi"}
knitr::include_graphics("images/12-mcnemar/mcnemar_results.png")
```
