...
In the data above, what is your **independent variable**? `r mcq(c("Participant", answer = "Condition", "Speech", "Conceptual", "Syntax", "TestScore"))`

In the data above, what is your **dependent variable**? `r mcq(c("Participant", "Condition", "Speech", "Conceptual", "Syntax", answer = "TestScore"))`
