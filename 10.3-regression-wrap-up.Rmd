...
```{r echo = FALSE, fig.cap = "Correlation as regression"}
knitr::include_graphics("images/14-regression-wrap-up/correlation.png")
```
...
```{r echo = FALSE, fig.cap = "Independent t-test as regression"}
knitr::include_graphics("images/14-regression-wrap-up/t-test.png")
```
...
```{r echo = FALSE, fig.cap = "Dependent t-test as regression"}
knitr::include_graphics("images/14-regression-wrap-up/dependent_t-test.png")
```
