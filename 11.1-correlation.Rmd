...
```{r echo = FALSE, fig.cap = "Scatter plots & correlation examples"}
knitr::include_graphics("images/08-correlation/correlation-examples.png")
```

```{block, type = "try"}
Try your hand at guessing the correlation coefficient! Play at www.guessthecorrelation.com
```

```{block, type = "try"}
Another fun website to play around with is the interactive visualization website Interpreting Correlations by Kristoffer Magnusson. You can play around with what data looks like at various correlations. https://rpsychologist.com/correlation/
```
...
**Practice**: Is the correlation coefficient of .5 with N=30 statistically significant? `r mcq(c(answer = "yes", "no"))`[^correlation-1]
...
```{r echo = FALSE, fig.cap = "Correlation setup in jamovi", out.width = "80%"}
knitr::include_graphics("images/08-correlation/correlation-setup.png")
```
...
```{r echo = FALSE, fig.cap = "Testing linearity in jamovi"}
knitr::include_graphics("images/08-correlation/correlation-plots.png")
```
...
```{r echo = FALSE, fig.cap = "Correlation results in jamovi"}
knitr::include_graphics("images/08-correlation/correlation-matrix.png")
```
...
```{r echo = FALSE, fig.cap = "Comparison of correlations from independent samples"}
knitr::include_graphics("images/08-correlation/compare-correlations-independent.png")
```
...
```{r echo = FALSE, fig.cap = "Advanced filters"}
knitr::include_graphics("images/08-correlation/correlation-filters.png")
```
...
```{r echo = FALSE, fig.cap = "Comparison of correlations from dependent samples"}
knitr::include_graphics("images/08-correlation/compare-correlations-dependent.png")
```
...
1.  **Are there significant correlations among the four tests (English, reading, math, writing)?**
    ...
    -   Do you meet the assumption of normality for all four tests? `r mcq(c("yes", "no", answer = "yes for all but maybe not writing"))`

    -   Do you meet the assumption of linearity for all four tests? `r mcq(c(answer = "yes", "no"))`

    -   Are the four tests significantly correlated among each other? `r mcq(c(answer = "yes", "no"))`

    -   Round your answers to two decimal places:

        -   What is the correlation between reading and math? `r fitb(".52")`

        -   What is the correlation between writing and reading? `r fitb(".11")`

        -   What is the correlation between writing and English? `r fitb(".37")`
