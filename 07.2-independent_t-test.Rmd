...
```{r echo = FALSE, fig.cap = "Independent t-test data in jamovi", out.width = "80%"}
knitr::include_graphics("images/02-independent_t-test/independent_t-test_data.png")
```

In the data above, what is your **independent variable**? `r mcq(c("ID", "grade", answer = "tutor"))`

In the data above, what is your **dependent variable**? `r mcq(c("ID", answer = "grade", "tutor"))`
...
knitr::include_graphics("images/02-independent_t-test/independent_t-test_descriptives_all.png")
```

```{r echo = FALSE, fig.cap = "Plot of the data", out.width = "80%"}
knitr::include_graphics("images/02-independent_t-test/independent_t-test_plot_all.png")
```
...
```{r echo = FALSE, fig.cap = "Plot of the data", out.width = "80%"}
knitr::include_graphics("images/02-independent_t-test/independent_t-test_skewkurtosis.png")
```
...
```{r echo = FALSE, fig.cap = "Independent t-test descriptives plot"}
knitr::include_graphics("images/02-independent_t-test/independent_t-test_plot2.png")
```
...
```{r echo = FALSE, fig.cap = "Independent t-test descriptives plot"}
knitr::include_graphics("images/02-independent_t-test/independent_t-test_plot.png")
```
...
2.  **Do athletes (Athlete: athletes = 1, non-athlete = 0) have faster sprint times than non-athletes?**
    ...
    -   Which statistic should you use based on your assumptions? `r mcq(c("independent t-test", "Welch t-test", answer = "Mann Whitney U"))`
...
3.  **Do students who live on campus (LiveOnCampus: on campus = 1, off campus = 0) have higher English scores than students who live off campus?**
    ...
    -   Which statistic should you use based on your assumptions? `r mcq(c("independent t-test", answer = "Welch t-test", "Mann Whitney U"))`
