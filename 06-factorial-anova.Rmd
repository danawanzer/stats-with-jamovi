...
knitr::include_graphics("images/06-factorial-anova/independent-factorial_assumptions.png")
```
...
```{r echo = FALSE, fig.cap = "Independent factorial ANOVA results in jamovi"}
knitr::include_graphics("images/06-factorial-anova/independent-factorial_results.png")
```
...
knitr::include_graphics("images/06-factorial-anova/independent-factorial_posthoc.png")
```
...
```{r echo = FALSE, fig.cap = "Interaction plot in jamovi"}
knitr::include_graphics("images/06-factorial-anova/independent-factorial_plot.png")
```
...
```{r echo = FALSE, fig.cap = "Assumption testing in jamovi"}
knitr::include_graphics("images/06-factorial-anova/rm-factorial_assumption.png")
```
...
```{r echo = FALSE, fig.cap = "Repeated measures ANOVA in jamovi"}
knitr::include_graphics("images/06-factorial-anova/rm-factorial_results.png")
```
...
```{r echo = FALSE, fig.cap = "Post hoc tests in jamovi"}
knitr::include_graphics("images/06-factorial-anova/rm-factorial_tukey.png")
```
...
```{r echo = FALSE, fig.cap = "Interaction plot in jamovi"}
knitr::include_graphics("images/06-factorial-anova/rm-factorial_interaction.png")
```
...
```{r echo = FALSE, fig.cap = "Assumption checking in jamovi"}
knitr::include_graphics("images/06-factorial-anova/mixed_assumptions.png")
```
...
```{r echo = FALSE, fig.cap = "Mixed factorial ANOVA in jamovi"}
knitr::include_graphics("images/06-factorial-anova/mixed_results.png")
```
...
```{r echo = FALSE, fig.cap = "Post hoc tests in jamovi"}
knitr::include_graphics("images/06-factorial-anova/mixed_posthoc.png")
```
...
```{r echo = FALSE, fig.cap = "Interaction plot in jamovi"}
knitr::include_graphics("images/06-factorial-anova/mixed_interaction.png")
```
