...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-cooks.png" alt="Checking for multivariate outliers in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-5)Checking for multivariate outliers in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-normality.png" alt="Checking the normality of residuals in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-6)Checking the normality of residuals in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-residuals.png" alt="Checking linearity and homoscedasticity residuals in jamovi" width="49%" />
<p class="caption">(\#fig:unnamed-chunk-7)Checking linearity and homoscedasticity residuals in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-durbinwatson.png" alt="Checking independence of residuals in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-8)Checking independence of residuals in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-multicollinearity.png" alt="Checking multicollinearity in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-9)Checking multicollinearity in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-results.png" alt="Regression results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-10)Regression results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/hierarchical-setup.png" alt="Hierarchical regression setup in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-11)Hierarchical regression setup in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/hierarchical-results.png" alt="Hierarchical regression results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-12)Hierarchical regression results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/transform.png" alt="Transforming day into a categorical variable in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-13)Transforming day into a categorical variable in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-categorical.png" alt="Regression with a categorical predictor results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-14)Regression with a categorical predictor results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/13-regression/regression-categorical-EMM.png" alt="Regression with a categorical predictor results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-15)Regression with a categorical predictor results in jamovi</p>
</div>
