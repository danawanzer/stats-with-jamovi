...
<img src="images/14-regression-wrap-up/correlation.png" alt="Correlation as regression" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-1)Correlation as regression</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/14-regression-wrap-up/t-test.png" alt="Independent t-test as regression" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-2)Independent t-test as regression</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/14-regression-wrap-up/dependent_t-test.png" alt="Dependent t-test as regression" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-3)Dependent t-test as regression</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-4)One-way ANOVA as a regression</p>
</div>
