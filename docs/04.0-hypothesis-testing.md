...
```r
knitr::include_url("https://www.youtube.com/watch?v=Eqs9L6gDaJg")
```
...
<iframe src="https://www.youtube.com/watch?v=Eqs9L6gDaJg" width="1\linewidth" height="400px"></iframe>
...
\caption{Critical area of statistical significance}(\#fig:unnamed-chunk-2)
\end{figure}
