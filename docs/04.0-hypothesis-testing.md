...
&lt; .00001 but we never go to so many decimals, so we would say p &lt;
.001. The probability of getting a t-value as large as we did it less
than .1% (less than our alpha of .05, so it is statistically
significant). Very surprising!</p>
