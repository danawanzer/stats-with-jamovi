...
-   $H_0$: The observed frequencies match the expected frequencies. In other words, the frequencies of the categories fo the independent variable are what we would expect.
