...
\caption{Correlation setup in jamovi}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{Testing linearity in jamovi}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Correlation results in jamovi}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Comparison of correlations from independent samples}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Advanced filters}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Comparison of correlations from dependent samples}(\#fig:unnamed-chunk-7)
\end{figure}
