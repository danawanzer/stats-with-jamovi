...
\caption{Contrasts - Deviation}(\#fig:unnamed-chunk-8)
\end{figure}
...
\caption{Contrasts - Simple}(\#fig:unnamed-chunk-9)
\end{figure}
...
\caption{Contrasts - Difference}(\#fig:unnamed-chunk-10)
\end{figure}
...
\caption{Contrasts - Helmert}(\#fig:unnamed-chunk-11)
\end{figure}
...
\caption{Contrasts - Repeated}(\#fig:unnamed-chunk-12)
\end{figure}
...
\caption{Contrasts - Polynomial}(\#fig:unnamed-chunk-13)
\end{figure}
