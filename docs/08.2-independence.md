...
<img src="images/11-independence/independence_setup.png" alt="Chi-square test of independence setup in jamovi" width="80%" />
<p class="caption">(\#fig:unnamed-chunk-1)Chi-square test of independence setup in jamovi</p>
</div>

### Interpreting results

<div class="figure" style="text-align: center">
<img src="images/11-independence/independence_results.png" alt="Chi-square test of independence results in jamovi" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-2)Chi-square test of independence results in jamovi</p>
</div>
