...
<img src="images/03_dependent_t-test/dependent_data.png" alt="Dependent t-test data in jamovi" width="80%" />
<p class="caption">(\#fig:unnamed-chunk-1)Dependent t-test data in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/03_dependent_t-test/dependent_descriptives.png" alt="Descriptive statistics" width="80%" />
<p class="caption">(\#fig:unnamed-chunk-2)Descriptive statistics</p>
</div>

<div class="figure" style="text-align: center">
<img src="images/03_dependent_t-test/dependent_descriptives.png" alt="Descriptive statistics" width="80%" />
<p class="caption">(\#fig:unnamed-chunk-3)Descriptive statistics</p>
</div>

<div class="figure" style="text-align: center">
<img src="images/03_dependent_t-test/dependent_plot1.png" alt="Plots of the data" width="49%" /><img src="images/03_dependent_t-test/dependent_plot2.png" alt="Plots of the data" width="49%" />
<p class="caption">(\#fig:unnamed-chunk-4)Plots of the data</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)Testing normality in jamovi</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)Dependent t-test setup in jamovi</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)Dependent t-test results in jamovi</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/03_dependent_t-test/dependent_results_plot.png" alt="Dependent t-test descriptives plot" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-8)Dependent t-test descriptives plot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/03_dependent_t-test/dependent_results_plot2.png" alt="Revised plot using the Rj editor" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-9)Revised plot using the Rj editor</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-11)All dependent t-test results in jamovi</p>
</div>
